...
export default function Successfully() {
  return (
    <div className="w-full h-dvh flex items-center px-16 flex-col">
      <div className="w-full py-8 ">
        <Lang width="w-25" />
      </div>
      <div className="w-full rounded-r-[30px] flex flex-col justify-center items-center border border-[#9797973D] gap-15 p-5">
