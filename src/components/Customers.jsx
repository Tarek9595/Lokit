...
export default function Customers() {
  return (
    <div className="w-full py-15 flex flex-col justify-center items-center lg:gap-10 gap-20 ">
          ...
          <div className="w-full lg:w-105 flex flex-col gap-6">
            <div className="flex flex-col gap-4.5 ">
              <p className="font-Montserrat font-normal text-[16px] lg:w-[85%] leading-7">
                "Great quality and fast delivery loved my order Absolutely loved
                my purchase ! Definitely shopping from lokit again !"
              </p>
